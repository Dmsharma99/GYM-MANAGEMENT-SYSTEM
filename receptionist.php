...
if(isset($_REQUEST["submit"])){
  ...
  $ins = "INSERT INTO receptionist (id, name, date, dob, phone, email) VALUES ('$id', '$NAME', '$DATE', '$DOB', '$PHONE', '$EMAIL')";
...
<body>
  ...
  <div class="form-group">
    ...
    <input type="text" name="dob" class="form-control" id="inputAddress" placeholder="DD/MM/YYYY">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" name="email" class="form-control" id="inputAddress2" placeholder="Email Id">
  </div>
